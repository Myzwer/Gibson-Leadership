            ...
            <div class="grid grid-cols-12 md:h-3/6">
                ...
                <div class="col-span-12 md:col-span-6 relative p-5 md:px-10 md:py-40">
                    <div class="content-middle-medium md:px-5">
                        <h1 class="uppercase text-black font-bold text-4xl md:text-5xl">GL Services</h1>
                        <h2 class="uppercase text-black text-2xl md:text-3xl pt-3">Short one sentence CTA of the services of Gibson Leadership</h2>
                    </div>
                </div>
            </div>
        </div>
